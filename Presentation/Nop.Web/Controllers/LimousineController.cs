    ...
    public class LimousineController : BaseNhaXeController
    {
        ...
        public ActionResult _DatVe(DatVeModel model)
        {
            ...
            if (model.Id > 0)
            {
                ...
                var _note = "HD " + _datveitem.Ma + " được sửa bởi " + string.Format("{0}({1})", _workContext.CurrentNhanVien.HoVaTen, _workContext.CurrentCustomer.Email);
        ...
        public ActionResult QuanLyChuyen()
        {
            ...
            model.KhuVucId = (int)ENKhuVuc.NINH_BINH;
        ...
        {
            if (!_workContext.CurrentNhanVien.isQuanTri && !(_workContext.CurrentNhanVien.KieuNhanVien == ENKieuNhanVien.KeToan))
            {
